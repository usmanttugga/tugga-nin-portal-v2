// ══════════════════════════════════════════════════════════════════════════════
// NIMC Integration Layer for TUGGA IT SOLUTIONS
// ══════════════════════════════════════════════════════════════════════════════
...
const NIMCIntegration = {
  ...
  deductFromWallet(userId, amount) {
    ...
    if (user && user.id === userId) {
      ...
      const allUsers = JSON.parse(localStorage.getItem('tugga_all_users') || '[]');
      const userIndex = allUsers.findIndex(u => u.id === userId);
      if (userIndex !== -1) {
        allUsers[userIndex].wallet = user.wallet;
        localStorage.setItem('tugga_all_users', JSON.stringify(allUsers));
      }
    }
  },
  ...
  getPricing() {
    ...
    const stored = localStorage.getItem('tugga_pricing');
  ...
  storeSlip(userId, transactionId, slip) {
    const slips = JSON.parse(localStorage.getItem('tugga_slips') || '[]');
    slips.push({
      userId,
      transactionId,
      slip,
    ...
    localStorage.setItem('tugga_slips', JSON.stringify(slips));
  },
    ...
    return `
      ...
      <body>
        <div class="slip-container">
          ...
          <div class="footer">
            <p>This is an official verification slip generated by TUGGA IT SOLUTIONS</p>
            <p>Verified through NIMC Database</p>
            <p>© ${new Date().getFullYear()} TUGGA IT SOLUTIONS. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
